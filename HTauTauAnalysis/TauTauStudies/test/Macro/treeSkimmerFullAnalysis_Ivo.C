...
void makeTrees_ElecTauStream(string analysis = "", int index = -1 /*, AntiElectronIDMVA* antiE=0*/){
  ...
  */
  ...
  samples.push_back("DYJets-ElecTau-50-madgraph-PUS6-v2_run"); crossSec.push_back( 3048           * 0.0537207         * 0.274235613418); 
  samples.push_back("TTJets-ElecTau-madgraph-PUS6_run");       crossSec.push_back( 157.5          * 0.0149329         * 0.804996291673);  
  samples.push_back("WJets-ElecTau-madgraph-PUS6_run");        crossSec.push_back(31314.0         * 0.0011910         * 0.550105297262);   
  samples.push_back("W3Jets-ElecTau-madgraph-PUS6_run");       crossSec.push_back( 304.0          * 1.0               * 0.10949076732);   
  samples.push_back("WZ-ElecTau-pythia-PUS6_run");             crossSec.push_back( 18.2           * 0.0111572         * 0.558101432973);         
  samples.push_back("ZZ-ElecTau-pythia-PUS6_run");             crossSec.push_back(  5.9           * 0.0160517         * 0.52915667466);    
  samples.push_back("WW-ElecTau-pythia-PUS6_run");             crossSec.push_back( 43.0           * 0.0092734         * 0.593562044286);        
  samples.push_back("VBFH100-ElecTau-powheg-PUS6_run");        crossSec.push_back( 8.36e-02*1.546 * 0.0499282         * 0.777353177796); 
  samples.push_back("GGFH100-ElecTau-powheg-PUS6_run");        crossSec.push_back( 8.36e-02*24.02 * 1.0               * 0.0528839662975); 
  samples.push_back("VBFH105-ElecTau-powheg-PUS6_run");        crossSec.push_back( 8.25e-02*1.472 * 1.0               * 0.10303125); 
  samples.push_back("GGFH105-ElecTau-powheg-PUS6_run");        crossSec.push_back( 8.25e-02*21.78 * 1.0               * 0.0572751547639); 
  samples.push_back("VBFH110-ElecTau-powheg-PUS6_run");        crossSec.push_back( 8.02e-02*1.398 * 0.0558070         * 0.776385960561);
  samples.push_back("GGFH110-ElecTau-powheg-PUS6_run");        crossSec.push_back( 8.02e-02*19.84 * 0.0441026         * 0.732993197279);    
  samples.push_back("VBFH115-ElecTau-powheg-PUS6_run");        crossSec.push_back( 7.65e-02*1.332 * 0.0586927         * 0.776047673972);
  samples.push_back("GGFH115-ElecTau-powheg-PUS6_run");        crossSec.push_back( 7.65e-02*18.13 * 0.0463465         * 0.745486569793);  
  samples.push_back("VBFH120-ElecTau-powheg-PUS6_run");        crossSec.push_back( 7.10e-02*1.269 * 1.0               * 0.114649200532);   
  samples.push_back("GGFH120-ElecTau-powheg-PUS6_run");        crossSec.push_back( 7.10e-02*16.63 * 1.0               * 0.0708727272727);  
  samples.push_back("VBFH125-ElecTau-powheg-PUS6_run");        crossSec.push_back( 6.37e-02*1.211 * 1.0               * 0.117115674648);   
  samples.push_back("GGFH125-ElecTau-powheg-PUS6_run");        crossSec.push_back( 6.37e-02*15.31 * 1.0               * 0.0737351614613); 
  samples.push_back("VBFH130-ElecTau-powheg-PUS6_run");        crossSec.push_back( 5.48e-02*1.154 * 1.0               * 0.120774098035); 
  samples.push_back("GGFH130-ElecTau-powheg-PUS6_run");        crossSec.push_back( 5.48e-02*14.12 * 1.0               * 0.0767107533065);
  samples.push_back("VBFH135-ElecTau-powheg-PUS6_run");        crossSec.push_back( 4.52e-02*1.100 * 1.0               * 0.124769142947); 
  samples.push_back("GGFH135-ElecTau-powheg-PUS6_run");        crossSec.push_back( 4.52e-02*13.08 * 0.0573246         * 0.74444346833);    
  samples.push_back("VBFH140-ElecTau-powheg-PUS6_run");        crossSec.push_back( 3.54e-02*1.052 * 1.0               * 0.125582608696);  
  samples.push_back("GGFH140-ElecTau-powheg-PUS6_run");        crossSec.push_back( 3.54e-02*12.13 * 1.0               * 0.085111381422);  
  samples.push_back("VBFH145-ElecTau-powheg-PUS6_run");        crossSec.push_back( 2.61e-02*1.004 * 1.0               * 0.129607549659);  
  samples.push_back("GGFH145-ElecTau-powheg-PUS6_run");        crossSec.push_back( 2.61e-02*11.27 * 1.0               * 0.0883433926223);  
  ...
  samples.push_back("VH100-ElecTau-pythia-PUS6_run");          crossSec.push_back( 2.61e-02*(1.186+ 0.6313+0.1638 ) * 1.0 * 0.133095082894);  
//samples.push_back("VH105-ElecTau-pythia-PUS6_run");          crossSec.push_back( 8.25e-02*(1.018+ 0.5449+0.1433 ) * 1.0 * 0.); 
  samples.push_back("VH110-ElecTau-pythia-PUS6_run");          crossSec.push_back( 8.02e-02*(0.8754+0.4721+0.1257 ) * 0.084386 * 0.786594682693);
  samples.push_back("VH115-ElecTau-pythia-PUS6_run");          crossSec.push_back( 7.65e-02*(0.7546+0.4107+0.1106 ) * 1.0 * 0.15181);
  samples.push_back("VH120-ElecTau-pythia-PUS6_run");          crossSec.push_back( 7.10e-02*(0.6561+0.3598+0.09756 ) * 1.0 * 0.156125776233);   
  samples.push_back("VH125-ElecTau-pythia-PUS6_run");          crossSec.push_back( 6.37e-02*(0.5729+0.3158+0.08634 ) * 1.0 * 0.1606);
  samples.push_back("VH130-ElecTau-pythia-PUS6_run");          crossSec.push_back( 5.48e-02*(0.4942+0.2778+0.07658 ) * 0.10051 * 0.799638235703);
  samples.push_back("VH135-ElecTau-pythia-PUS6_run");          crossSec.push_back( 4.52e-02*(0.4390+0.2453+0.06810 ) * 0.10133 * 0.803371710526);
  samples.push_back("VH140-ElecTau-pythia-PUS6_run");          crossSec.push_back( 3.54e-02*(0.3857+0.2172+0.06072 ) * 1.0 * 0.173385207932);  
  samples.push_back("VH145-ElecTau-pythia-PUS6_run");          crossSec.push_back( 2.61e-02*(0.3406+0.1930+0.05435 ) * 0.10708 * 0.802488804685);  
  //samples.push_back("VH160-ElecTau-pythia-PUS6_run");  crossSec.push_back( 5.32e-04*(0.2291+0.1334+0.03942 ) * 1.0 * 0.2120560);  
  samples.push_back("QCD-20to30-BCtoE-ElecTau-pythia-PUS6_run");     crossSec.push_back( 236000000*0.00056 * 1.0         * 0.00145172962306);  
  samples.push_back("QCD-30to80-BCtoE-ElecTau-pythia-PUS6_run");     crossSec.push_back( 59480000*0.0023   * 1.0         * 0.029226320363);  
  ...
  float sihih_, dEta_, dPhi_, HoE_,antiConv_, tightestDanieleMVAWP_,nHits_,ratioPtMaxMatchPtGenElec_,ptHighestLeg1Matched_;
  ...
  int isTauLegMatched_,isElecLegMatched_,elecFlag_,genDecay_,leg1GenDecay_, leptFakeTau;
  ...
  outTreePtOrd->Branch("antiConv", &antiConv_,"antiConv/F");
  outTreePtOrd->Branch("leg1GenDecay",&leg1GenDecay_,"leg1GenDecay/I");
  outTreePtOrd->Branch("ptHighestLeg1Matched",&ptHighestLeg1Matched_,"ptHighestLeg1Matched/F");
  outTreePtOrd->Branch("ratioPtMaxMatchPtGenElec",&ratioPtMaxMatchPtGenElec_,"ratioPtMaxMatchPtGenElec/F");
  ...
  outTreePtOrd->Branch("tightestDanieleMVAWP",      &tightestDanieleMVAWP_,"tightestDanieleMVAWP/F");
  ...
  outTreePtOrd->Branch("nHits",                &nHits_,"nHits/F");
  ...
  string currentInName =  "/data_CMS/cms/ivo/Trees/ElecTauStream_20Feb2012/treeElecTauStream_"+samples[index]+".root";
  //  string currentInName =  "/data_CMS/cms/ivo/Trees/ElecTauStream_08Feb2012/treeElecTauStream_"+samples[index]+".root";
//   string currentInName = index >= 0 ?  "/data_CMS/cms/lbianchini/ElecTauStreamFall11_06Dec2011//treeElecTauStream_"+samples[index]+".root" : "../treeElecTauStream.root";
  ...
  currentTree->SetBranchStatus("tightestDanieleMVAWP"  ,1);
  currentTree->SetBranchStatus("antiConv"  ,1);
  currentTree->SetBranchStatus("leg1GenDecay"          ,1);
  currentTree->SetBranchStatus("ptHighestLeg1Matched"  ,1);
  currentTree->SetBranchStatus("ratioPtMaxMatchPtGenElec",1);
  ...
  int tightestCutBasedWP, tightestCiCWP, tightestMVAWP, tightestAntiEMVAWP;
  float sihih, dEta, dPhi, HoE, nHits, antiConv, tightestDanieleMVAWP,ptHighestLeg1Matched,ratioPtMaxMatchPtGenElec;
  float numPV;
  float mcPUweight,embeddingWeight;
  int numOfLooseIsoDiTaus;
  int isTauLegMatched,isElecLegMatched,elecFlag,genDecay,leg1GenDecay, nPUVertices, nPUVerticesM1,nPUVerticesP1;
  ...
  currentTree->SetBranchAddress("tightestDanieleMVAWP", &tightestDanieleMVAWP);
  ...
  currentTree->SetBranchAddress("antiConv",             &antiConv);
  currentTree->SetBranchAddress("leg1GenDecay",         &leg1GenDecay);
  currentTree->SetBranchAddress("ptHighestLeg1Matched", &ptHighestLeg1Matched);
  currentTree->SetBranchAddress("ratioPtMaxMatchPtGenElec", &ratioPtMaxMatchPtGenElec);
  ...
  for (int n = 0; n < nEntries ; n++) {
    ...
    tightestDanieleMVAWP_      = tightestDanieleMVAWP;
    sihih_ = sihih; 
    dEta_  = dEta; 
    dPhi_  = dPhi; 
    HoE_   = HoE;
    nHits_=nHits;
    //cout<<"in anticonv: "<<antiConv<<endl;
    antiConv_   = antiConv;
    //cout<<"out anticonv: "<<antiConv_<<endl;
    leg1GenDecay_    = leg1GenDecay;
    ptHighestLeg1Matched_ = ptHighestLeg1Matched;
    ratioPtMaxMatchPtGenElec_ = ratioPtMaxMatchPtGenElec;
    //////////
    ...
    */ 
    ...
    tightestAntiEMVAWP_ = tightestAntiEMVAWP+1;//0 failed 1 pass
...
void doAllSamplesElec(){
  ...
  */
   ...
   for( unsigned int k = 38; k < 40 ; k++) {//37
     //int k = 1;
