...
void makeTrees_ElecTauStream(string analysis_ = "", string sample_ = "", float xsec_ = 0., string inputDir_ = "./"){
  ...
  TString outName = "/data_CMS/cms/ivo/HTauTauAnalysis/Trees/"+inputDir_+"/OpenNtuples/nTuple"+sample+"_Open_ElecTauStream_"+analysisFileName+".root";
...
int main(int argc, const char* argv[])
{
  ...
  doAllSamplesElec( "ElecTauStreamFall11_04May2012_Approval");
  return 1;  
  /*
  string inputDir = "ElecTauStreamFall11_04May2012_Approval";
