...
void produce(   
  ...
  in.open(Form("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/Limits/htautau/results/MuTau/muTau_%s_mH%d_%s.txt", 
	       binNameSpace.c_str(), mH_, variable_.c_str()));
  ofstream out(Form("/home/llr/cms/lbianchini/CMSSW_4_2_5/src/Bianchi/Limits/htautau/results/MuTau/systematics/muTau_%s_mH%d_%s_%sX%.2f.txt", 
