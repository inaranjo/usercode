...
void plotElecTau( TString mH_           = "120",
		  Int_t useEmbedding_ = 0,
		  TString selection_   = "inclusive",
		  TString analysis_    = "",		  
		  TString variable_   = "diTauVisMass",
		  TString XTitle_     = "full mass",
		  TString Unities_    = "GeV",
		  TString outputDir   = "./",
		  TString inputDir   = "/data_CMS/cms/ivo/HTauTauAnalysis/Trees/ElecTauStream_01Aug2012/OpenNtuples",
		  Int_t nBins_ = 80, Float_t xMin_=0, Float_t xMax_=300,
...
//   TString postfix_ = "Raw";
  ...
  ofstream out("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_2_6/src/Bianchi/Limits/bin/htautau/histograms/"+outputDir+"/yieldsElecTau_mH"+mH_+"_"+selection_+"_"+analysis_+".txt",ios_base::out); 
  out.precision(5);
  out<< " => " << selection_ << endl;
  ...
  char* c = new char[10];
  is.open("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_2_6/src/Bianchi/Limits/bin/htautau/bins/bins_eTau_"+variable_+"_"+selection_+".txt"); 
  if(nBins_<0 &&  !is.good()){
    cout << "Bins file not found : "<<"/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_2_6/src/Bianchi/Limits/bin/htautau/bins/bins_eTau_"+variable_+"_"+selection_+".txt"<< endl;
    return;
  }
  ...
  // from lumiCalc2
  float Lumi   = 5.082;
//   float lumiCorrFactor = (1/1.056);//2011 before 1-0.056
  float lumiCorrFactor = 0.976;//2012
  Lumi *= lumiCorrFactor;

  //////////////////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////////////////

  //For TTbar: ratio of mesured xsection by CMS over theoretical xsection. 
...
//   float VbfExtrapolationFactorW   = 1.23;//modify
//   float BoostExtrapolationFactorW = 1.11;
  ...
  leg->SetHeader(Form("#splitline{CMS Preliminary #sqrt{s}=8 TeV}{%.1f fb^{-1} #tau_{e}#tau_{had}}", Lumi ));
  ...
  TH1F* hZmmLoose= new TH1F( "hZmmLoose","Z+jets, e to tau (loose)", nBins , bins.GetArray());
 ...
 cout << scaleFactTauW << endl;
  ...
  // Open the files
  TString fDataName = inputDir+"/nTupleRun2012-ElecTau-All_run_Nominal.root";
  TString fDataEmbeddedName = inputDir+"/nTupleRun2012A-ElecTau-Embedded-All_run_Nominal.root";
  TString fSignalVBFName = inputDir+"/nTupleVBFH"+mH_+"-ElecTau_run_Nominal.root";
  TString fSignalGGHName = inputDir+"/nTupleGGFH"+mH_+"-ElecTau_run_Nominal.root";
  TString fBackgroundDYName = inputDir+"/nTupleDYJetsToLL-ElecTau_run_Nominal.root";
  TString fBackgroundWJetsName = inputDir+"/nTupleWJetsToLNu-ElecTau_run_Nominal.root";
  TString fBackgroundTTbarName = inputDir+"/nTupleTTJets-ElecTau_run_Nominal.root";
  TString fBackgroundOthersName = inputDir+"/nTupleOthers-ElecTau_run_Nominal.root";
  TString fSignalggH125Name = inputDir+"/nTupleGGFH125-ElecTau_run_Nominal.root";
  TString fSignalqqH125Name = inputDir+"/nTupleVBFH125-ElecTau_run_Nominal.root";
  if(analysis_.Contains("TauUp")) {
    fDataEmbeddedName = inputDir+"/nTupleRun2012A-ElecTau-Embedded-All_run_TauUp.root";
    fSignalVBFName = inputDir+"/nTupleVBFH"+mH_+"-ElecTau_run_TauUp.root";
    fSignalGGHName = inputDir+"/nTupleGGFH"+mH_+"-ElecTau_run_TauUp.root";
    fBackgroundDYName = inputDir+"/nTupleDYJetsToLL-ElecTau_run_TauUp.root";
    fBackgroundWJetsName = inputDir+"/nTupleWJetsToLNu-ElecTau_run_TauUp.root";
    fBackgroundTTbarName = inputDir+"/nTupleTTJets-ElecTau_run_TauUp.root";
    fBackgroundOthersName = inputDir+"/nTupleOthers-ElecTau_run_TauUp.root"; 
    fSignalggH125Name = inputDir+"/nTupleGGFH125-ElecTau_run_TauUp.root";
    fSignalqqH125Name = inputDir+"/nTupleVBFH125-ElecTau_run_TauUp.root";
  }
  if(analysis_.Contains("TauDown")) {
    fDataEmbeddedName = inputDir+"/nTupleRun2012A-ElecTau-Embedded-All_run_TauDown.root";
    fSignalVBFName = inputDir+"/nTupleVBFH"+mH_+"-ElecTau_run_TauDown.root";
    fSignalGGHName = inputDir+"/nTupleGGFH"+mH_+"-ElecTau_run_TauDown.root";
    fBackgroundDYName = inputDir+"/nTupleDYJetsToLL-ElecTau_run_TauDown.root";
    fBackgroundWJetsName = inputDir+"/nTupleWJetsToLNu-ElecTau_run_TauDown.root";
    fBackgroundTTbarName = inputDir+"/nTupleTTJets-ElecTau_run_TauDown.root";
    fBackgroundOthersName = inputDir+"/nTupleOthers-ElecTau_run_TauDown.root"; 
    fSignalggH125Name = inputDir+"/nTupleGGFH125-ElecTau_run_TauDown.root";
    fSignalqqH125Name = inputDir+"/nTupleVBFH125-ElecTau_run_TauDown.root";
  }

  TFile *fData              
    = new TFile(fDataName, "READ");  
  TFile *fDataLooseIso              
    = new TFile(fDataName, "READ");  
  TFile *fDataEmbedded              
    = new TFile(fDataEmbeddedName, "READ"); 
  TFile *fSignalVBF         
    = new TFile(fSignalVBFName,"READ");  
  TFile *fSignalGGH         
    = new TFile(fSignalGGHName,"READ"); 
//   TFile *fSignalVH         
//     = new TFile(Form(inputDir+"/nTupleVH%d-ElecTau_run_Nominal.root",mH_,"READ");
  TFile *fBackgroundDY
    = new TFile(fBackgroundDYName,"READ"); 
  TFile *fBackgroundWJets   
    = new TFile(fBackgroundWJetsName,"READ"); 
//   TFile *fBackgroundW3Jets   
//     = new TFile(inputDir+"/nTupleW3Jets-ElecTau_run_Nominal.root","READ"); 
  TFile *fBackgroundTTbar  
    = new TFile(fBackgroundTTbarName,"READ"); 
  TFile *fBackgroundOthers  
    = new TFile(fBackgroundOthersName,"READ"); 
...
//   hMasses.push_back(145);
  ...
  TFile *fSignalggH110 =          
    new TFile(inputDir+"/nTupleGGFH110-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalggH115 =          
    new TFile(inputDir+"/nTupleGGFH115-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalggH120 =          
    new TFile(inputDir+"/nTupleGGFH120-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalggH125 =          
    new TFile(fSignalggH125Name ,"READ");  
  TFile *fSignalggH130 =          
    new TFile(inputDir+"/nTupleGGFH130-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalggH135 =          
    new TFile(inputDir+"/nTupleGGFH135-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalggH140 =          
    new TFile(inputDir+"/nTupleGGFH140-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalggH145 =          
    new TFile(inputDir+"/nTupleGGFH145-ElecTau_run_Nominal.root" ,"READ");  

//   TFile *fSignalqqH110 =          
//     new TFile(inputDir+"/nTupleVBFH110-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalqqH115 =          
//     new TFile(inputDir+"/nTupleVBFH115-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalqqH120 =          
    new TFile(inputDir+"/nTupleVBFH120-ElecTau_run_Nominal.root" ,"READ");  
  TFile *fSignalqqH125 =          
    new TFile(fSignalggH125Name,"READ");  
//   TFile *fSignalqqH130 =          
//     new TFile(inputDir+"/nTupleVBFH130-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalqqH135 =          
//     new TFile(inputDir+"/nTupleVBFH135-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalqqH140 =          
//     new TFile(inputDir+"/nTupleVBFH140-ElecTau_run_Nominal.root" ,"READ");
  TFile *fSignalqqH145 =          
    new TFile(inputDir+"/nTupleVBFH145-ElecTau_run_Nominal.root" ,"READ");  
 
//   TFile *fSignalVH110 =          
//     new TFile(inputDir+"/nTupleVH110-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH115 =          
//     new TFile(inputDir+"/nTupleVH115-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH120 =          
//     new TFile(inputDir+"/nTupleVH120-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH125 =          
//     new TFile(inputDir+"/nTupleVH125-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH130 =          
//     new TFile(inputDir+"/nTupleVH130-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH135 =          
//     new TFile(inputDir+"/nTupleVH135-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH140 =          
//     new TFile(inputDir+"/nTupleVH140-ElecTau_run_Nominal.root" ,"READ");  
//   TFile *fSignalVH145 =          
//     new TFile(inputDir+"/nTupleVH145-ElecTau_run_Nominal.root" ,"READ");  
 
//   std::map<TString,TFile*> mapSUSYfiles;
//   for(unsigned int i = 0; i < SUSYhistos.size() ; i++){
//     mapSUSYfiles.insert( make_pair(SUSYhistos[i], new TFile(inputDir+"/nTuple%s-ElecTau_run_Nominal.root",SUSYhistos[i].c_str()) ,"READ")  )  );
//   }
  ...
  if(analysis_.Contains("TauDown")) 
    treeEmbedded = tree;
  if(analysis_.Contains("ElecUp")) 
    treeEmbedded = tree;
  if(analysis_.Contains("ElecDown")) 
    treeEmbedded = tree;

  TTree *data                = (TTree*)fData->Get(("outTreePtOrd"+postfix_));
  TTree *dataLooseIso        = LOOSEISO  ? (TTree*)fDataLooseIso->Get(("outTreePtOrd"+postfix_)) : 0;
...
//   TTree *signalVH            = addVH ? (TTree*)fSignalVH->Get(tree) : 0;
  ...
  TTree *backgroundW3Jets    = W3JETS ? (TTree*)fBackgroundWJets->Get(tree) : 0;//modify
...
//   }
  ...
  ///// LEPT PT ///////
  TCut lpt("ptL1>24 && TMath::Abs(etaL1)<2.1");// && MEtCorr>25
  ...
  //5loose 6medium 7tight
//   TCut tiso("tightestHPSMVAWP>=0 && tightestAntiEMVAWP>=6"); 
//   TCut tAiso("tightestHPSMVAWP>=0 && tightestAntiEMVAWP<6"); 
//   TCut ltiso("tightestHPSMVAWP>-99 && tightestAntiEMVAWP>=6"); 
  ...
  TCut hltevent("pairIndex<1 && HLTx==1 && (run>=190456 || run==1)");
  TCut hltmatch("HLTmatch==1");

  TCut pZ(   antiWcut + "<" + antiWsgn );
  TCut apZ(  antiWcut + ">" + antiWsdb );
  TCut apZ2( antiWcut + ">" + antiWsdb + " && " + antiWcut + "<100");
  ...
  boost = boost && !vbf /*&& !vh*/;
  if(selection_.Contains("novbf") || selection_.Contains("boost") )
    boost = boost&&TCut("MEtCorr>25");
...
//   TCut novbf("nJets30<1 && nJets20BTagged<1");
  TCut novbf("nJets30<1 ");
  if(selection_.Contains("novbf") || selection_.Contains("boost") )
    novbf = novbf&&TCut("MEtCorr>25");

  TCut MCWeight("sampleWeight*puWeight2012*HLTweightTau*HLTweightElec*SFTau*SFElec");
  TCut MCWeightHqT("sampleWeight*puWeight2012*HLTweightTau*HLTweightElec*SFElec*SFTau*HqTWeight");
  ...
  else if(selection_.Contains("vbf") && !selection_.Contains("novbf")){
  ...
  else if(selection_.Contains("novbf")){
  ...
  if(selection_.Contains("vbf") && !selection_.Contains("novbf")){
  ...
  backgroundDYTauTau->Draw(variable+">>hExtrap",MCWeight*sbin);

  float ExtrapolationFactorMadGraph = hExtrap->Integral()*lumiCorrFactor*Lumi*hltEff_/ExtrapDYInclusive;
  ...
  hExtrap->Reset();
  backgroundWJets->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&pZ));
  float ExtrapSSWinSignalRegionMC   = hExtrap->Integral();
  hExtrap->Reset();
  backgroundWJets->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ));
  ...
  hExtrap->Reset();
  backgroundTTbar->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ));
  float ExtrapttbarExtrSS    = hExtrap->Integral()*Lumi*hltEff_*TTxsectionRatio;

  hExtrap->Reset();
  backgroundTTbar->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")));
  float ExtrapttbarExtrSSBtag = hExtrap->Integral()*Lumi*hltEff_*TTxsectionRatio;
  hExtrap->Reset();
  backgroundWJets->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")));
  float ExtrapwjetsExtrSSBtag = hExtrap->Integral()*Lumi*hltEff_;
  hExtrap->Reset();
  backgroundOthers->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")));
  ...
  hExtrap->Reset();
  backgroundOthers->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ));
  float ExtrapothersExtrSS   = hExtrap->Integral()*Lumi*hltEff_;
  hExtrap->Reset();
  backgroundDYJtoTau->Draw(variable+">>hExtrap",MCWeight*(sbinPZetaRelSSInclusive&&apZ));
  ...
  hExtrap->Reset();
  backgroundTTbar->Draw(variable+">>hExtrap", MCWeight*sbinSSInclusive);
  SSeventsExtrap  -= hExtrap->Integral()*Lumi*hltEff_*TTxsectionRatio*scaleFactorTTSS;
  hExtrap->Reset();
  backgroundDYEtoTau->Draw(variable+">>hExtrap", MCWeight*sbinSSInclusive);
  SSeventsExtrap  -= hExtrap->Integral()*Lumi*lumiCorrFactor*hltEff_*EtoTauCorrectionFactor;

  hExtrap->Reset();
  backgroundDYJtoTau->Draw(variable+">>hExtrap", MCWeight*sbinSSInclusive);
  SSeventsExtrap  -= hExtrap->Integral()*Lumi*lumiCorrFactor*hltEff_*JtoTauCorrectionFactor;
  hExtrap->Reset();

  //SSeventsExtrap *= OStoSSRatioQCD;//modify
  ...
  ///////////////////////////////////////// Doing OS first...
  hWMt->Reset();
  backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&pZ));
  cout << "Using  " << hWMt->GetEntries() << " entries from the W+jets OS sample" << endl;
  float OSWinSignalRegionMC   = hWMt->Integral()*Lumi*hltEff_;
  hWMt->Reset();
  backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ));
  ...
  hWMt->Reset();
  cout << "Estimating contribution from Ztt, ttbar and others in OS low pZeta tail..." << endl;
  backgroundTTbar->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ));
  ...
  if(selection_.Contains("boost"))
    backgroundTTbar->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelInclusive&&apZ&&TCut("nJets20BTagged>1")&&TCut("pt1>30")&&(!vbf)));
  else
    backgroundTTbar->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ&&TCut("nJets20BTagged>1")));
  float ttbarExtrOSBtag = hWMt->Integral()*Lumi*hltEff_*TTxsectionRatio;
  hWMt->Reset();

  if(selection_.Contains("boost"))
    backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelInclusive&&apZ&&TCut("nJets20BTagged>1")&&TCut("pt1>30")&&(!vbf)));
  else
    backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ&&TCut("nJets20BTagged>1")));
  float wjetsExtrOSBtag = hWMt->Integral()*Lumi*hltEff_;
  hWMt->Reset();

  if(selection_.Contains("boost"))
    backgroundOthers->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelInclusive&&apZ&&TCut("nJets20BTagged>1")&&TCut("pt1>30")&&(!vbf)));
  else
    backgroundOthers->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ&&TCut("nJets20BTagged>1")));
  ...
  backgroundOthers->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ));
  float othersExtrOS = hWMt->Integral()*Lumi*hltEff_;
  cout << "Contribution from single-t and di-boson in OS is " << othersExtrOS << endl;
  hWMt->Reset();
  backgroundDYTauTau->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ));
  ...
  hWMt->Reset();
  backgroundDYJtoTau->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ));
  ...
  hWMt->Reset();
  backgroundDYEtoTau->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRel&&apZ));
  float dyetotauExtrOS = hWMt->Integral()*Lumi*lumiCorrFactor*hltEff_;
  ...
  ///////////////////////////////////////// Doing SS last...
  hWMt->Reset();
  backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&pZ));
  cout << "Using  " << hWMt->GetEntries() << " entries from the SS W+jets sample" << endl;
  float SSWinSignalRegionMC   = hWMt->Integral()*Lumi*hltEff_;
  hWMt->Reset();
  backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ));
  ...
  backgroundTTbar->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ));
  float ttbarExtrSS = hWMt->Integral()*Lumi*hltEff_*TTxsectionRatio;
  cout << "Contribution from ttbar in SS is " << ttbarExtrSS << endl;


  if(selection_.Contains("boost"))
    backgroundTTbar->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")&&TCut("pt1>30")&&(!vbf)));
  else
    backgroundTTbar->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ&&TCut("nJets20BTagged>1")));
  float ttbarExtrSSBtag = hWMt->Integral()*Lumi*hltEff_*TTxsectionRatio;
  hWMt->Reset();

  if(selection_.Contains("boost"))
    backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")&&TCut("pt1>30")&&(!vbf)));
  else
    backgroundWJets->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ&&TCut("nJets20BTagged>1")));
  float wjetsExtrSSBtag = hWMt->Integral()*Lumi*hltEff_;
  hWMt->Reset();

  if(selection_.Contains("boost"))
    backgroundOthers->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSSInclusive&&apZ&&TCut("nJets20BTagged>1")&&TCut("pt1>30")&&(!vbf)));
  else
    backgroundOthers->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ&&TCut("nJets20BTagged>1")));
  ...
  hWMt->Reset();
  backgroundOthers->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ));
  float othersExtrSS = hWMt->Integral()*Lumi*hltEff_;
  cout << "Contribution from single-t and di-boson in SS is " << othersExtrSS << endl;
  hWMt->Reset();
  backgroundDYJtoTau->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ));
  ...
  hWMt->Reset();
  backgroundDYEtoTau->Draw(variable+">>hWMt",MCWeight*(sbinPZetaRelSS&&apZ));
  float dyetotauExtrSS = hWMt->Integral()*Lumi*lumiCorrFactor*hltEff_;
...
//   tMap["VH115"]        = signalVH;
  ...
  tMap["W3Jets"]       = backgroundWJets;//Modify
...
//   }
  ...
  for( unsigned iter=0; iter<samples.size(); iter++){
	...
	sFWSS *= BoostExtrapolationFactorW;
      ...
      hHelp->Reset();
      backgroundTTbar->Draw(variable+">>hHelp", MCWeight*sbinSS);
      ...
      hHelp->Reset();
      backgroundDYEtoTau->Draw(variable+">>hHelp", MCWeight*sbinSS);
      cout << "We expect " << hHelp->Integral()*Lumi*lumiCorrFactor*hltEff_ << " SS events from DY->ee, e->jet" << endl;
      hHelp->Scale(EtoTauCorrectionFactor*Lumi*lumiCorrFactor*hltEff_);
      ...
      hHelp->Reset();
      backgroundDYJtoTau->Draw(variable+">>hHelp", MCWeight*sbinSS);
      cout << "We expect " << hHelp->Integral()*Lumi*lumiCorrFactor*hltEff_ << " SS events from DY->ee, jet->tau" << endl;
      hHelp->Scale(JtoTauCorrectionFactor*Lumi*hltEff_);
      ...
      if(!(it->first).Contains("Embed")){ // if not embedded

	if((it->first).Contains("DYToTauTau")){
	  currentTree->Draw(variable+">>"+h1Name, MCWeight*sbinPZetaRelInclusive);  
	  float madgraphNoMEtCut = h1->Integral();
	  h1->Reset();
	  currentTree->Draw(variable+">>"+h1Name, MCWeight*sbinInclusive);
	  madgraphMEtCutEff = h1->Integral()/madgraphNoMEtCut;
	  cout << "Efficiency of antiW cut on madgraph " << madgraphMEtCutEff << endl;
	  h1->Reset();
	  currentTree->Draw(variable+">>"+h1Name, MCWeight*sbin);
	}// if DYToTauTau
	else if((it->first).Contains("W3Jets")){

	  currentTree->Draw(variable+">>"+h1Name,     MCWeightHqT*sbin);
	  hW3JetsKeys = new TH1Keys("hW3JetsKeys","W+3jets smoothed", nBins , bins.GetArray());
	  currentTree->Draw(variable+">>hW3JetsKeys", MCWeightHqT*sbin);
	  ...
	  h1->Reset();
	  if((selection_.Contains("vbf") && !selection_.Contains("novbf")) || selection_.Contains("twoJets") ){
	    ...
	    currentTree->Draw(variable+">>"+h1Name,MCWeight*(sbinMtisoInclusive&&vbfLoose));
	    ...
	    hHelp->Reset();
	    currentTree->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ&&vbfLoose));
	    cout << hHelp->Integral() << endl;
	    float W3JetsVBFSdb    = hHelp->Integral();
	    float W3JetsVBFSdbInt = hHelp->GetEntries();
	    hHelp->Reset();
	    currentTree->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&pZ&&vbfLoose));
	    ...
	    hHelp->Reset();
            currentTree->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&vbfLoose));
            cout << hHelp->Integral() << endl;
//             float W3JetsVBFAll    = hHelp->Integral();
//             float W3JetsVBFAllInt = hHelp->GetEntries();

	    // SIDEBAND2 OS: get extrap factor (2)
	    hHelp->Reset();
            currentTree->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbfLoose));
            cout << hHelp->Integral() << endl;
	    ...
	    hHelp->Reset();
            currentTree->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbfLoose));
	    cout << hHelp->Integral() << endl;
            float W3JetsVBFSdbSS    = hHelp->Integral();
            float W3JetsVBFSdbIntSS = hHelp->GetEntries();
            hHelp->Reset();
            currentTree->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&pZ&&vbfLoose));
	    ...
	    hHelp->Reset();
	    backgroundDYTauTau->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYEtoTau->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYJtoTau->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundOthers->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf));
	    ...
	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf&&TCut("nJets20BTagged>0")));
	    float TTbarVBFSdbBtag = hHelp->Integral()*Lumi*hltEff_*TTxsectionRatio;
	    hHelp->Reset();
	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf&&TCut("nJets20BTagged>-999")));
	    ...
	    hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbfLoose));
            cout << hHelp->Integral() << endl;
            float TTJetsVBFSdb2    = hHelp->Integral();
            float TTJetsVBFSdbInt2 = hHelp->GetEntries();
            hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&pZ&&vbfLoose));
...
//          hHelp->Reset();
//          backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf));
//          float TTbarVBFSdb2 = hHelp->Integral()*Lumi*hltEff_*TTxsectionRatio;
...
// 	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf&&TCut("nJets20BTagged>0")));
// 	    float TTbarVBFSdb2Btag = hHelp->Integral()*Lumi*hltEff_*TTxsectionRatio;
// 	    hHelp->Reset();
// 	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ2&&vbf&&TCut("nJets20BTagged>-999")));
// 	    float TTbarVBFSdb2AnyBtag = hHelp->Integral()*Lumi*hltEff_*TTxsectionRatio;
...
//          cout << "Estimation of W+jets (2) in the VBF category is " << normalization2 << endl;
	    ...
	    hHelp->Reset();
	    backgroundDYEtoTau->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundDYJtoTau->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
	    backgroundOthers->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    hHelp->Reset();
            ...
            hHelp->Reset();
            backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbf));
	    ...
	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbf&&TCut("nJets20BTagged>0")));
	    float TTbarVBFSdbSSBtag = hHelp->Integral()*Lumi*hltEff_*TTxsectionRatio;
	    hHelp->Reset();
	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelSSInclusive&&apZ2&&vbf&&TCut("nJets20BTagged>-999")));
	    ...
	    currentTree->Draw(variable+">>"+h1Name,MCWeight*sbinLtiso);
	    hW3JetsLooseTauIso->Add(h1,1.0);//fill anyway W3jets in not vbf cat
	  }//if not vbf

	  cout << "Filling histo with loose taus and FR" << endl;
	  h1->Reset();
	  if(selection_.Contains("vbf") && selection_.Contains("novbf")){
	    currentTree->Draw(variable+">>"+h1Name,MCWeight*TCut(scaleFactTauW.c_str())*(sbinLtisoInclusive&&vbfLoose));
	    ...
	    hHelp->Reset();
	    currentTree->Draw(variable+">>hHelp",MCWeight*TCut(scaleFactTauW.c_str())*(sbinPZetaRelLtisoInclusive&&apZ&&vbfLoose));
	    float W3JetsVBFSdb    = hHelp->Integral();
	    float W3JetsVBFSdbInt = hHelp->GetEntries();
	    hHelp->Reset();
	    currentTree->Draw(variable+">>hHelp",MCWeight*TCut(scaleFactTauW.c_str())*(sbinPZetaRelLtisoInclusive&&pZ&&vbfLoose));
	    float W3JetsVBFSgn    = hHelp->Integral();
	    float W3JetsVBFSgnInt = hHelp->GetEntries();
	    cout << "W3jets MC in VBF(rel): using " << W3JetsVBFSdbInt << " events from sideband and " << W3JetsVBFSgnInt << " from signal region" << endl;
	    ...
	    cout << "In VBF region, I get " << DataVBFSdb << " events in the high Mt sdb" << endl;
	    hHelp->Reset();
	    backgroundTTbar->Draw(variable+">>hHelp",MCWeight*(sbinPZetaRelInclusive&&apZ&&vbf));
	    float TTbarVBFSdb = hHelp->Integral()*Lumi*hltEff_*TTxsectionRatio;
	    cout << "In VBF region, I expect " << TTbarVBFSdb << " events in the high Mt sdb from TTbar" << endl;
	    hHelp->Reset();
	    data->Draw(variable+">>hHelp",(TCut(scaleFactElec.c_str()))*(sbinPZetaRelSSaIsoInclusive&&apZ&&vbf));
	    float QCDVBFSdb = hHelp->Integral()*OStoSSRatioQCD;
	    cout << "In VBF region, I measure " << QCDVBFSdb << " events in the high Mt sdb from anti-isolated events" << endl;
	    ...
	    currentTree->Draw(variable+">>"+h1Name,MCWeight*TCut(scaleFactTauW.c_str())*sbinLtiso);
	    hW3JetsLooseTauIsoFR->Add(h1,1.0);
	  }// if not vbf
	  h1->Reset();
	  currentTree->Draw(variable+">>"+h1Name,     MCWeightHqT*sbin);
	  ...
	  currentTree->Draw(variable+">>hZmjKeys", MCWeightHqT*sbin);
	  ...
	  currentTree->Draw(variable+">>hVVKeys", MCWeightHqT*sbin);
	...
	else//All others samples
	  if(currentTree) currentTree->Draw(variable+">>"+h1Name, MCWeightHqT*sbin);
	  else cout << "NO SUCH TREE" << endl;
      } // if not embedded
      else{//if embedded
	...
	h1->Scale(lumiCorrFactor);
      ...
      float sFWOS = ( selection_.Contains("novbf")   || 
		      selection_.Contains("boost")  || 
		      selection_.Contains("bTag")   || 
		      selection_.Contains("oneJet")  || 
		      selection_.Contains("twoJets")  || 		    
	...
	TH1F* hHelp = new TH1F( "hHelp" ,"" , nBins , bins.GetArray());
	currentTree->Draw(variable+">>hHelp", MCWeightHqT*sbinMtiso);
	...
	//}
	h1->Scale(sF);
	hZmm->Add(h1,1.0);//modify
	//hZmm->Add(hZmmKeys,1.0);
	hZfakes->Add(h1,1.0);
      }// if DYToEE->Tau
	...
	hZfakes->Add(h1,1.0);
      ...
      if((it->first).Contains("ggH115") && selection_.Contains("boost")){
	h1->Scale(kFactorSM);
      }
...
// 	hVV->Add(hVVKeys,1.0);
    ...
    if((it->first).Contains("ggH110")){
      hggH110->Add(h1,1.0);
      hggH110->SetLineWidth(2);
    }
    if((it->first).Contains("ggH115")){
      hggH115->Add(h1,1.0);
      hggH115->SetLineWidth(2);
    }
    if((it->first).Contains("ggH120")){
      hggH120->Add(h1,1.0);
      hggH120->SetLineWidth(2);
    }
    if((it->first).Contains("ggH125")){
      hggH125->Add(h1,1.0);
      hggH125->SetLineWidth(2);
    }
    if((it->first).Contains("ggH130")){
      hggH130->Add(h1,1.0);
      hggH130->SetLineWidth(2);
    }
    if((it->first).Contains("ggH135")){
      hggH135->Add(h1,1.0);
      hggH135->SetLineWidth(2);
    }
    if((it->first).Contains("ggH140")){
      hggH140->Add(h1,1.0);
      hggH140->SetLineWidth(2);
    }
    if((it->first).Contains("ggH145")){
      hggH145->Add(h1,1.0);
      hggH145->SetLineWidth(2);
    }

    if((it->first).Contains("qqH110")){
      hqqH110->Add(h1,1.0);
      hqqH110->SetLineWidth(2);
    }
    if((it->first).Contains("qqH115")){
      hqqH115->Add(h1,1.0);
      hqqH115->SetLineWidth(2);
    }
    if((it->first).Contains("qqH120")){
      hqqH120->Add(h1,1.0);
      hqqH120->SetLineWidth(2);
    }
    if((it->first).Contains("qqH125")){
      hqqH125->Add(h1,1.0);
      hqqH125->SetLineWidth(2);
    }
    if((it->first).Contains("qqH130")){
      hqqH130->Add(h1,1.0);
      hqqH130->SetLineWidth(2);
    }
    if((it->first).Contains("qqH135")){
      hqqH135->Add(h1,1.0);
      hqqH135->SetLineWidth(2);
    }
    if((it->first).Contains("qqH140")){
      hqqH140->Add(h1,1.0);
      hqqH140->SetLineWidth(2);
    }
    if((it->first).Contains("qqH145")){
      hqqH145->Add(h1,1.0);
      hqqH145->SetLineWidth(2);
    }

    if((it->first).Contains("VH110")){
      hVH110->Add(h1,1.0);
      hVH110->SetLineWidth(2);
    }
    if((it->first).Contains("VH115")){
      hVH115->Add(h1,1.0);
      hVH115->SetLineWidth(2);
    }
    if((it->first).Contains("VH120")){
      hVH120->Add(h1,1.0);
      hVH120->SetLineWidth(2);
    }
    if((it->first).Contains("VH125")){
      hVH125->Add(h1,1.0);
      hVH125->SetLineWidth(2);
    }
    if((it->first).Contains("VH130")){
      hVH130->Add(h1,1.0);
      hVH130->SetLineWidth(2);
    }
    if((it->first).Contains("VH135")){
      hVH135->Add(h1,1.0);
      hVH135->SetLineWidth(2);
    }
    if((it->first).Contains("VH140")){
      hVH140->Add(h1,1.0);
      hVH140->SetLineWidth(2);
    }
    if((it->first).Contains("VH145")){
      hVH145->Add(h1,1.0);
...
//     aStack->Add(hEWK);
  ...
  float uncertZtt = 0;
  if(selection_.Contains("novbf") || selection_.Contains("inclusive") ||
  ...
  c1->SaveAs("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_2_6/src/Bianchi/Limits/bin/htautau/plots/"+outputDir+"/plot_eTau_mH"+mH_+"_"+selection_+"_"+analysis_+"_"+variable+".png");
  c1->SaveAs("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_2_6/src/Bianchi/Limits/bin/htautau/plots/"+outputDir+"/plot_eTau_mH"+mH_+"_"+selection_+"_"+analysis_+"_"+variable+".pdf");

  // templates for fitting
  TFile* fout = new TFile("/home/llr/cms/ivo/HTauTauAnalysis/CMSSW_5_2_6/src/Bianchi/Limits/bin/htautau/histograms/"+outputDir+"/eTau_mH"+mH_+"_"+selection_+"_"+analysis_+"_"+variable+".root","RECREATE");
...
void plotElecTauAll(Int_t useEmbedded = 1, 
		    TString outputDir = "ElecTauStream_01Aug2012",
		    TString inputDir = "/data_CMS/cms/ivo/HTauTauAnalysis/Trees/ElecTauStream_01Aug2012/OpenNtuples"
		    )
{
...
//   mH.push_back(120);
  ...
  //plotElecTau("125",1,"vbf",""   ,"decayMode","decay mode", ""    ,inputDir,outputDir,3,0, 3,5.0,1.0,0,1.2);
  //return;


//   plotElecTau("125",1,"inclusive","" ,"MtLeg1MVA","M_{T}","GeV" ,             outputDir,inputDir,40,0,160,5.0,1.0,0,1.2);
  //plotElecTau("125",1,"inclusive",""   ,"diTauVisMass","visible mass","GeV" ,  outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
  //return;

//   plotElecTau("125",1,"inclusive",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"inclusive",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"inclusive",""   ,"ptL2","#tau p_{T}","GeV"           ,outputDir,inputDir,27,11, 92,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"inclusive",""   ,"ptL1","e p_{T}", "GeV"           ,outputDir,inputDir,27,11, 92,5.0,1.0,0,1.2);
//   plotElecTau("125",0,"inclusive",""   ,"etaL1","e #eta", "units"         ,outputDir,inputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
//   plotElecTau("125",0,"inclusive",""   ,"etaL2","#tau #eta","units"         ,outputDir,inputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
//   plotElecTau("125",1,"inclusive",""   ,"MEtCorr","MET","GeV"                    ,outputDir,inputDir,40,0,100,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"inclusive",""   ,"MEtCorrPhi","MET #phi","units"          ,outputDir,inputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
//   plotElecTau("125",1,"inclusive",""   ,"MtLeg1Corr","M_{T}","GeV" ,             outputDir,inputDir,40,0,160,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"inclusive",""   ,"hpsMVA","#tau MVA","units"              ,outputDir,inputDir,50,0.75,1.0, 5.0,1.0,0,1.8);
//   plotElecTau("125",1,"inclusive",""   ,"MEtMVA","MET","GeV"                    ,outputDir,inputDir,40,0,100,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"inclusive",""   ,"MEtMVAPhi","MET #phi","units"          ,outputDir,inputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
//   plotElecTau("125",0,"inclusive",""   ,"numPV","reconstructed vertexes","units"             ,outputDir,inputDir,35,0,35,5.0,1.0,0,1.5);
//   plotElecTau("125",1,"inclusive",""   ,"nJets30","jet multiplicity","units"                 ,outputDir,inputDir,10,0, 10,5.0,1.0,1,10);
//   plotElecTau("125",1,"inclusive",""   ,"nJets20BTagged","b-tagged jet multiplicity","units" ,outputDir,inputDir,5,0, 5,5.0,1.0,1,10);
   plotElecTau("125",1,"inclusive",""      ,"pt1","leading jet p_{T}","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
   plotElecTau("125",1,"inclusive",""      ,"eta1","leading jet #eta","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
   plotElecTau("125",1,"inclusive",""      ,"pt2","subleading jet p_{T}","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
   plotElecTau("125",1,"inclusive",""      ,"eta2","subleading jet #eta","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);

//   plotElecTau("125",1,"vbf",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"vbf",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"vbf",""   ,"ptL2","#tau p_{T}","GeV"           ,outputDir,inputDir,27,11, 92,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"vbf",""   ,"ptL1","e p_{T}", "GeV"           ,outputDir,inputDir,27,11, 92,5.0,1.0,0,1.2);
//   plotElecTau("125",0,"vbf",""   ,"etaL1","e #eta", "units"         ,outputDir,inputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
//   plotElecTau("125",0,"vbf",""   ,"etaL2","#tau #eta","units"         ,outputDir,inputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
//   plotElecTau("125",1,"vbf",""   ,"MEtCorr","MET","GeV"                    ,outputDir,inputDir,40,0,100,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"vbf",""   ,"MEtCorrPhi","MET #phi","units"          ,outputDir,inputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
//   plotElecTau("125",1,"vbf",""   ,"MtLeg1Corr","M_{T}","GeV" ,             outputDir,inputDir,40,0,160,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"vbf",""   ,"hpsMVA","#tau MVA","units"              ,outputDir,inputDir,50,0.75,1.0, 5.0,1.0,0,1.8);

//   plotElecTau("125",1,"novbf",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"ptL2","#tau p_{T}","GeV"           ,outputDir,inputDir,27,11, 92,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"ptL1","e p_{T}", "GeV"           ,outputDir,inputDir,27,11, 92,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"etaL1","e #eta", "units"         ,outputDir,inputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
//   plotElecTau("125",1,"novbf",""   ,"etaL2","#tau #eta","units"         ,outputDir,inputDir,25,-2.5, 2.5,5.0,1.0,0,2.);
//   plotElecTau("125",1,"novbf",""   ,"MEtCorr","MET","GeV"                    ,outputDir,inputDir,40,0,100,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"MEtCorrPhi","MET #phi","units"          ,outputDir,inputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
//   plotElecTau("125",1,"novbf",""   ,"MtLeg1Corr","M_{T}","GeV" ,             outputDir,inputDir,40,0,160,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"hpsMVA","#tau MVA","units"              ,outputDir,inputDir,50,0.75,1.0, 5.0,1.0,0,1.8);
//   plotElecTau("125",1,"novbf",""   ,"MEtMVA","MET","GeV"                    ,outputDir,inputDir,40,0,100,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbf",""   ,"MEtMVAPhi","MET #phi","units"          ,outputDir,inputDir,32,-3.2,3.2,   5.0,1.0,0,1.5);
//   plotElecTau("125",0,"novbf",""   ,"numPV","reconstructed vertexes","units"             ,outputDir,inputDir,35,0,35,5.0,1.0,0,1.5);
//   plotElecTau("125",1,"novbf",""   ,"nJets30","jet multiplicity","units"                 ,outputDir,inputDir,10,0, 10,5.0,1.0,1,10);
//   plotElecTau("125",1,"novbf",""   ,"nJets20BTagged","b-tagged jet multiplicity","units" ,outputDir,inputDir,5,0, 5,5.0,1.0,1,10);
   plotElecTau("125",1,"novbf",""      ,"pt1","leading jet p_{T}","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
   plotElecTau("125",1,"novbf",""      ,"eta1","leading jet #eta","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
   plotElecTau("125",1,"novbf",""      ,"pt2","subleading jet p_{T}","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
   plotElecTau("125",1,"novbf",""      ,"eta2","subleading jet #eta","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);

//   plotElecTau("125",1,"novbfLow",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbfLow",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);

//   plotElecTau("125",1,"novbfHigh",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"novbfHigh",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);

//   plotElecTau("125",1,"boostLow",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"boostLow",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);

//   plotElecTau("125",1,"boostHigh",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"boostHigh",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);

//   plotElecTau("125",1,"bTagLow",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"bTagLow",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);

//   plotElecTau("125",1,"bTagHigh",""   ,"diTauVisMass","visible mass","GeV"      ,outputDir,inputDir,50,0,200,5.0,1.0,0,1.2);
//   plotElecTau("125",1,"bTagHigh",""   ,"diTauNSVfitMass","SVfit mass","GeV"     ,outputDir,inputDir,50,0,300,5.0,1.0,0,1.2);



//   plotElecTau("125",1,"bTag",""        ,"ptB1", "leading b-tagged jet p_{T}","GeV"       ,outputDir,inputDir,20,30, 230,5.0,1.0,1,100);
//   plotElecTau("125",1,"bTag",""        ,"etaB1","leading b-tagged jet #eta","units"      ,outputDir,inputDir,10,-5, 5,5.0,1.0,0,2.);
  
//    plotElecTau("125",1,"twoJets",""   ,"MtLeg1Corr","M_{T}","GeV" ,                    outputDir,inputDir,20,0,160,5.0,1.0,0,1.2);
//    plotElecTau("125",1,"oneJet",""   , "MtLeg1Corr","M_{T}","GeV" ,                    outputDir,inputDir,20,0,160,5.0,1.0,0,1.2);

//    plotElecTau("125",1,"oneJet",""      ,"pt1","leading jet p_{T}","GeV"       ,outputDir,inputDir,50,30, 330,5.0,1.0,1,100);
//    plotElecTau("125",1,"oneJet",""      ,"eta1","leading jet #eta","units"     ,outputDir,inputDir,21,-5, 5,5.0,1.0,0,2.);
//    plotElecTau("125",1,"twoJets",""     ,"pt1","leading jet p_{T}","GeV"       ,outputDir,inputDir,30,30, 330,5.0,1.0,1,200);
//    plotElecTau("125",1,"twoJets",""     ,"pt2","trailing jet p_{T}","GeV"      ,outputDir,inputDir,30,30, 330,5.0,1.0,1,100);
//    plotElecTau("125",1,"twoJets",""     ,"eta1","leading jet #eta","units"     ,outputDir,inputDir,21,-5, 5,5.0,1.0,0,2.);
//    plotElecTau("125",1,"twoJets",""     ,"eta2","trailing jet #eta","units"    ,outputDir,inputDir,21,-5, 5,5.0,1.0,0,2.);
//    plotElecTau("125",1,"twoJets",""     ,"Deta","|#Delta#eta|_{jj}","units"    ,outputDir,inputDir,20,0, 8,   5.0,1.0,0,1.5);
//    plotElecTau("125",1,"twoJets",""     ,"Mjj","M_{jj}","GeV"                  ,outputDir,inputDir,20,0, 1000,5.0,1.0,1,100);
//    plotElecTau("125",1,"twoJets",""     ,"MVAvbf","BDT output","units"         ,outputDir,inputDir,10,-1, 1,5.0,1.0,1,100);
   
   //plotElecTau("125",1,"twoJets",""     ,"ptVeto","veto jet p_{T}","GeV"       ,outputDir,inputDir,18,20, 200,5.0,1.0,1,200);
   //plotElecTau("125",1,"twoJets",""     ,"etaVeto","veto jet #eta","units"     ,outputDir,inputDir,10,-5, 5,5.0,1.0,0,2.);
   
   //plotElecTau("125",1,"twoJets",""     ,"diJetPt","di-jet p_{T}","GeV"           ,outputDir,inputDir,15,0, 300,5.0,1.0,0,1.5);
   //plotElecTau("125",1,"twoJets",""     ,"dPhiHjet","(di-jet - H) #phi","units",outputDir,inputDir,32,0, 3.2,5.0,1.0,0,1.5);
   //plotElecTau("125",1,"twoJets",""     ,"c2","di-tau vis p_{T}","GeV"         ,outputDir,inputDir,20,0, 200,5.0,1.0,0,1.5);
   //plotElecTau("125",1,"twoJets",""     ,"c1","min#Delta#eta j-H","units"      ,outputDir,inputDir,20,0,10,5.0,1.0,0,1.5);
  ...
  for(unsigned int i = 0 ; i < variables.size(); i++){
    for(unsigned j = 0; j < mH.size(); j++){
      ...
      plotElecTau(mH[j],useEmbedded,"inclusive",""   ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
      plotElecTau(mH[j],useEmbedded,"inclusive","TauUp"   ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
      plotElecTau(mH[j],useEmbedded,"inclusive","TauDown"   ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"novbf",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);


       plotElecTau(mH[j],useEmbedded,"vbf",""         ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
       plotElecTau(mH[j],useEmbedded,"vbf","TauUp"    ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
       plotElecTau(mH[j],useEmbedded,"vbf","TauDown"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"vbf","JetUp"    ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"vbf","JetDown"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);

//         plotElecTau(mH[j],useEmbedded,"novbfLow",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfLow","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfLow","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfLow","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfLow","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);

//         plotElecTau(mH[j],useEmbedded,"novbfHigh",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfHigh","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfHigh","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfHigh","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"novbfHigh","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
      
//         plotElecTau(mH[j],useEmbedded,"boostLow",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostLow","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostLow","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostLow","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostLow","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
      
//         plotElecTau(mH[j],useEmbedded,"boostHigh",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostHigh","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostHigh","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostHigh","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//        plotElecTau(mH[j],useEmbedded,"boostHigh","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);

//       plotElecTau(mH[j],useEmbedded,"bTagLow",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagLow","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagLow","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagLow","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagLow","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);

//       plotElecTau(mH[j],useEmbedded,"bTagHigh",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,5.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagHigh","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagHigh","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagHigh","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"bTagHigh","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);


//       plotElecTau(mH[j],useEmbedded,"vh",""       ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"vh","TauUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"vh","TauDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"vh","JetUp"  ,variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
//       plotElecTau(mH[j],useEmbedded,"vh","JetDown",variables[i],"mass","GeV",outputDir,inputDir,-1,0,100,1.0,1.0,0,1.2);
...
int main(int argc, const char* argv[])
{
  ...
  //plotElecTau();
  plotElecTauAll();
  //plotElecTau("125",1,"inclusive","","diTauVisMass","","","Dec2011/iter3",10,0,7000);
  //plotElecTau("125",1,"novbf","",    "diTauVisMass","","","Dec2011/iter3",10,0,7000);
  //plotElecTau("125",1,"boost","",    "diTauVisMass","","","Dec2011/iter3",10,0,7000);
  //plotElecTau("125",1,"vbf","",      "diTauVisMass","","","Dec2011/iter3",10,0,7000);
