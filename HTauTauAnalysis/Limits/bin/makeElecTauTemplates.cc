...
void produce(   
  ...
  TFile* fin = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/histograms/%s/eTau_mH%d_%s_%s_%s.root", outputDir.Data(), mH_, bin_.c_str() , analysis_.c_str(), variable_.c_str()), "READ");

  TFile* fin_jUp   = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/histograms/%s/eTau_mH%d_%s_JetUp_%s.root",   outputDir.Data(), mH_, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_jDown = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/histograms/%s/eTau_mH%d_%s_JetDown_%s.root", outputDir.Data(), mH_, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_tUp   = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/histograms/%s/eTau_mH%d_%s_TauUp_%s.root",   outputDir.Data(), mH_, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_tDown = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/histograms/%s/eTau_mH%d_%s_TauDown_%s.root", outputDir.Data(), mH_, bin_.c_str() , variable_.c_str()), "READ");
  TFile* fin_nominal = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/histograms/%s/eTau_mH%d_%s__%s.root", outputDir.Data(), mH_, bin_.c_str() , variable_.c_str()), "READ");
  ...
  TFile* fTemplOut = new TFile(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/datacards/%s/eTauSM_%s.root",outputDir.Data(), variable_.c_str()),"UPDATE");
  ...
  in.open(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/templates/eTau_%s_template_v2.txt",     binNameSpace.c_str()));
  ofstream out(Form("/home/llr/cms/ivo/CMSSW_4_2_8_patch7/src/Bianchi/Limits/htautau/datacards/%s/eTau_%s_mH%d_%s.txt", outputDir.Data(), binNameSpace.c_str(), mH_, variable_.c_str()));
  out.precision(8);
...
void produceAll(  TString outputDir = "ElecTauStream_28Feb2012" ){
